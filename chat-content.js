...
const ChatContent = {
    ...
    messages: [
        // Text messages
        {
            ...
            content: {
                ...
                lines: [
                    ...
                    "",
                    "File Path:",
                    "c:\\inetpub\\wwwroot\\custA\\maintenance\\as3dsff-a352-4g30-be12-4382sfg2r.aspx",
                    "",
                    "Status:",
                    "Pending",
                    "",
        ...
        },
        {
            ...
            content: {
                ...
                lines: [
                    ...
                    "1. Quarantine webshell file c:\\inetpub\\wwwroot\\custA\\maintenance\\as3dsff-a352-4g30-be12-4382sfg2r.aspx",
        ...
        },
        {
            ...
            type: "csm",
            sender: "Sangfor-CSM",
            content: "Yes, I will send out the incident report upon completion of the scan to the agreed designated recipients."
        },
        {
            id: 23,
            type: "t2",
            sender: "Sangfor-T2",
            content: "Hi @CustA-PIC1, we discovered the following code vulnerability in the file c:\\inetpub\\wwwroot\\custA\\controllers\\coduploadcontrollers.cs. You will need to refine the code to allow only safe file type upload."
        },
        {
            id: 24,
            type: "t2",
